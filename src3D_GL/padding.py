...
def unpad_2x(uhat_pad,arrange):
  ...
  ## Remove padding from the middle of the 3D cube
  uhat[0:N1/2, : ,0:N3-1] = uhat_pad[0:N1/2      , : ,0:N3-1] #left lower back (0,0,0)
  uhat[N1/2::, : ,0:N3-1] = uhat_pad[2*N1-N1/2:: , : ,0:N3-1] #right lower back (1,0,0)
  return uhat
...
def pad_2x(uhat,arrange):
  N1,N2,N3 = np.shape(uhat)
  ## Add padding to the middle of the 3D cube
  uhat_pad = np.zeros((2*N1,N2,2*N3-1),dtype = 'complex')
  uhat_pad[0:N1/2      , : ,0:N3-1] = uhat[0:N1/2, : ,0:N3-1] #left lower back (0,0,0)
  uhat_pad[2*N1-N1/2:: , : ,0:N3-1] = uhat[N1/2::, : ,0:N3-1] #right lower back (1,0,0)
  return uhat_pad
